...
import com.jiqu.process.models.AndroidProcess;
...
public class ProcessManager {
  ...
  public static List<ActivityManager.RunningAppProcessInfo> getRunningAppProcessInfo(Context ctx) {
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      List<ActivityManager.RunningAppProcessInfo> appProcessInfos = new ArrayList<ActivityManager.RunningAppProcessInfo>();
