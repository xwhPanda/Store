...
public class RecommendDataInfo {
	...
	public String toString() {
		return "RecommendDataInfo [status=" + status + ", data1=" + Arrays.toString(data1) + ", data2=" + Arrays.toString(data2) + ", data3=" + Arrays.toString(data3) + ", data4=" + Arrays.toString(data5) + ", data5=" + Arrays.toString(data5) + ", data6=" + Arrays.toString(data6) + ", data7=" + Arrays.toString(data7) + "]";
	}
}
